...
execute if entity @s[tag=edit_minecart2] run scoreboard players set $frame_edit rc_pos_x 1
execute if entity @s[tag=edit_minecart3] run scoreboard players set $frame_edit rc_pos_x 2
execute if entity @s[tag=edit_minecart10] run scoreboard players set $frame_edit rc_pos_x 3
execute if entity @s[tag=edit_minecart12] run scoreboard players set $frame_edit rc_pos_x 4
