...
tellraw @s ["",{"text":"Animation ","color":"yellow"},{"nbt":"Clipboard.Name","storage":"minecraft:animation","bold":true,"color":"aqua"},{"text":" has been successfully pasted with id ","color":"yellow"},{"nbt":"Clipboard.id","storage":"minecraft:animation","bold":false,"color":"white"}]
