...
data merge storage minecraft:animation {APIMode:0,Bukkit:0,DPCheck2:1,RecordSettings:{},Event:{},Animation:[],EditAnimation:[],DelAnimation:[],Length:0,TempFrame:[],TempAnimation:{id:0,Name:"",Length:0,Frames:[]},idList:[],Menu:[],MenuData:{1:{},2:{},3:{},4:{},5:{}}}
data modify storage minecraft:animation DefaultSettings set value {id:0,Name:"Missing Name",Length:0,Frames:[],Loop:0,Relative:0,Beginning:0,Manual:0,Sync:0,Frequency:0,Reverse:0,Speed:2,Position:1,Rotation:1,Item:1,Placed:1,Broken:1,Spawned:1,Sneaking:1}
