#Append new array
execute unless score @s rc_menu = $frame_event rc_menu run data modify entity @s data.TempEvent append from entity @s data.Frame.Event[0]
execute if score @s rc_menu = $frame_event rc_menu run data modify entity @s data.TempTempEvent set from entity @s data.Frame.Event[0]
