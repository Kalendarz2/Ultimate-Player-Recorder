...
data merge storage minecraft:animation {Bukkit:0,DPCheck2:1,RecordSettings:{},Event:{},Animation:[],EditAnimation:[],DelAnimation:[],Length:0,TempFrame:[],TempAnimation:{id:0,Name:"",Length:0,Frames:[]},idList:[],Menu:[],MenuData:{1:{},2:{},3:{},4:{},5:{}}}
