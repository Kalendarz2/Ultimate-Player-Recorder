execute as @p[tag=this,tag=!rc_sound] at @s run playsound minecraft:block.note_block.xylophone master @s ~ ~ ~ 1 1
tag @p[tag=this] add rc_sound
...
data modify storage minecraft:animation TempBlock.Placed append from storage minecraft:animation TempBlock.Temp
